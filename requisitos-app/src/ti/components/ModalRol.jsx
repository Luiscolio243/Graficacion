      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm">
        ...
        <div className="flex items-center justify-between px-6 py-5 border-b border-gray-100">
          <div>
            ...
            <p className="text-xs text-gray-400 mt-0.5">Define un nuevo rol para el equipo de TI</p>
          </div>
        ...
        <div className="px-6 py-5 space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="Ej: Desarrollador, QA, Analista"
              className={inputCls}
              autoFocus
          ...
          <div>
            <label className={labelCls}>Descripción <span className="text-gray-400 font-normal normal-case">(opcional)</span></label>
            <textarea
